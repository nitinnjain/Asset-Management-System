	...
	<div class="container-fluid">
		...
		<div class="container">
			<form class="form-horizontal"
				...
				<div class="form-group">
					<label>Manager ID: </label> <input class="form-control" type="text"
						name="manager_id">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label>Phone Number: </label> <input class="form-control"
						type="text" name="employee_phone_number">
				</div>
				<div class="form-group">
					<label>Postinng City: </label> <input class="form-control"
						type="text" name="employee_posting_city">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label>Flat/House/Floor/Building: </label> <input
						class="form-control" type="text" name="flat_house_building_floor">
				</div>
				<div class="form-group">
					<label>Colony/Street/Locality: </label> <input class="form-control"
						type="text" name="colony_street_locality">
				</div>
				<div class="form-group">
