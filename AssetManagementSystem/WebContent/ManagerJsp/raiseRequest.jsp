...
<body style="text-align: center; paddinng: 0px 300px">
	<%
	...
	<div class="container-fluid">
		<div>
			...
			<div id="search_by_name_form" style="display: none;">
				<form class="form-horizontal"
					action="/AssetManagementSystem/ManagerController" method="post">
					<input type="hidden" name="operation" value="search">

					<div class="form-group">
						<label class="control-label col-sm-2" for="search_category">Name:</label>
						<div class="col-sm-10">
		...
		<script type="text/javascript">
			function searchName() {
				...
				//document.getElementById('search_box').innerHTML = "<input type='text' name='search_by_name' placeholder='Enter name to search'>";
			}
			...
			function searchKeyword() {
				...
				document.getElementById('search_by_category_form').style.display = "none";
				//document.getElementById('search_box').innerHTML = "<input type='text' name='search_by_keyword' placeholder='Enter keyword to search'>";
			}
