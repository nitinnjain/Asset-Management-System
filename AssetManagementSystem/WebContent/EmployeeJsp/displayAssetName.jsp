	...
	<div class="container-fluid">
				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a
								href="/AssetManagementSystem/EmployeeJsp/myProfile.jsp">Change
									Password</a></li>
						</ul></li>
		...
		<div class="container">
			<table class="table table-striped table-hover">
				...
				<tr>
					<td>
						<%=assetId = ape.getAssetId()%>
					</td>
					<td>
						<%=assetName = ape.getAssetName()%>
					</td>
					<td><%=ape.getAssetDescription()%></td>
					<td><a
						href="/AssetManagementSystem/EmployeeJsp/finalRaiseRequest.jsp?asset_id=<%=assetId%>&&asset_name=<%=assetName%>">Raise
							Request</a></td>
				</tr>
				<%
					}
