	...
	<div class="container-fluid">
		...
		<div class="container-fluid">
			<form class="form-horizontal"
				...
				<input type="hidden" name="operation" value="tech_support">
				<div class="form-group">
					<label for="comment">Details</label>
					<textarea class="form-control" id="comment" rows="5" cols="50"
						name="user_query" maxlength="100"></textarea>
				</div>
				<div class="form-group">
					<input class="btn btn-primary" type="submit" value="Raise Request">
				</div>
			</form>
		</div>
	</div>
